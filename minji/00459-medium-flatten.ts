...
1. type Flatten<T extends any[]> = T extends [infer First, ...infer Rest] ? First extends any[] ? Flatten<[...First, Rest]> : [First, ...Flatten<Rest>] : []
=> Flatten<[1, [2]]> - 무한 루프 발생
=> 해결: Rest를 spread해서 넘겨주기
 */
